      ...
      <div className='w-full max-w-lg bg-white p-8 shadow-lg'>
        <section className='h-full max-h-[500px] w-full overflow-auto px-1 py-4 text-gray700'>
          ...
          <ul className='mb-4 list-decimal pl-5'>
            <li className='mb-4'>
              이 약관은 Hilight Brands(전자상거래 사업자)(이)가 운영하는 말본골프 | malbon golf(이하 "몰"이라 한다)에서
            ...
            <li className='mb-4'>
              ...
              위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러
              사이버몰을 운영하는 사업자의 의미로도 사용합니다.② "이용자"란 "몰"에 접속하여 이 약관에 따라 "몰"이
              제공하는 서비스를 받는 회원 및 비회원을 말합니다.③ '회원'이라 함은 "몰"
            </li>
            <li className='mb-4'>
