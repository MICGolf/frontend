...
//       <button
//         className='flex w-full items-center justify-between border border-gray-300 bg-white px-4 py-2 text-left focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500'
...
//       {isOpen && (
//         <ul
//           className='absolute top-full z-10 mt-1 max-h-60 w-full overflow-auto bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm'
//           role='listbox'
//         >
//           {options.map((option) => (
//             <li
